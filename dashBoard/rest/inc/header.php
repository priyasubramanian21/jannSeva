...
$session = new session();
$session->start();
$getStatus = $helpher->checkInitialPSC($_SESSION["user"]['UserId']);
// CHeck Pmf status
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="home"><img src="asset/image/logo/jle.png" width="100%" class="mr-2" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="home"><img src="asset/image/logo/jle.png" width="100%" alt="logo" /></a>
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                ...
                if ($getStatus != 1) { ?>
                    <span class="bg-danger" style="color:white"> Pay PMF !! Your process disable . </span> <?php } ?>
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                            ...
                            <a class="dropdown-item" href="privilegeCard">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item <?php echo $MPMF; ?>">
                        <a class="nav-link" href="psc">
                            ...
                            <span class="menu-title">PSC</span>
                        </a>
                    </li>
                    <?php
