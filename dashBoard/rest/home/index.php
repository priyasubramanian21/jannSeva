                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card " style="padding: 10px;box-shadow: 1px 0px 10px 0px;">
                                <div class="card-people mt-auto">
                                    ...
                                    <?php $cards = array("c1", "c2", "c3", "c4", "c5");

                                shuffle($cards);
                                   $card = $cards['0'];
                                    echo "<img src='asset/image/home/$card.png' alt='people'>";
                                ...
                                ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p> Total Give Help
                                            : <?php $giveHelp = $user->totalGiveHelp($_SESSION["user"]['UserId']);
                                            echo $giveHelp ?></p>
                                        <p> Total PMF : <?php $PMF1 = $user->totalPayedPMF($_SESSION["user"]['UserId']);
                                            echo round($PMF1, 2) ?></p>
                                        <p> Total Tax : <?php echo round($user->totalPayedTax($PMF1), 2); ?></p>
                                        <p class="fs-30 mb-2"><small> <small>Total Received Help
                                                    :<?php $receivedHelp = $user->totalReceivedHelp($_SESSION["user"]['UserId']);
